...
import ro.nicuch.astralbooks.storage.types.JsonStorage;
import ro.nicuch.astralbooks.storage.types.MySQLStorage;
import ro.nicuch.astralbooks.storage.types.SQLiteStorage;
...
public class Storage {
    ...
    public Storage(CitizensBooksPlugin plugin) {
        this.plugin = plugin;
    }
