...
package ro.nicuch.astralbooks.utils;
...
public enum Message {
    ...
    USAGE_SETCMD("usage.setcmd", "&aUsage: &f/npcbook setcmd <command> <filter name> [permission]"),
    ...
    USAGE_INTERACTION_SET_BLOCK("usage.interaction.set.block", "&aUsage: &f/npcbook interaction set block [right/left]"),
    USAGE_INTERACTION_SET_ENTITY("usage.interaction.set.entity", "&aUsage: &f/npcbook interaction set entity [right/left]"),
    USAGE_INTERACTION_REMOVE_BLOCK("usage.interaction.remove.block", "&aUsage: &f/npcbook interaction remove block [right/left]"),
    USAGE_INTERACTION_REMOVE_ENTITY("usage.interaction.remove.entity", "&aUsage: &f/npcbook interaction remove entity [right/left]"),
    ...
    HELP_SETCMD("help.setcmd", "&f/npcbook setcmd <command> <filter name> [permission] $ &9Set command by the given filter name."),
    ...
    HELP_INTERACTION_SET_ENTITY("help.interaction.set.entity", "&f/npcbook interaction set entity [right/left] $ &9Apply a book on an entity."),
    HELP_INTERACTION_REMOVE_BLOCK("help.interaction.remove.block", "&f/npcbook interaction remove block [right/left] $ &9Remove a book from a block."),
    HELP_INTERACTION_REMOVE_ENTITY("help.interaction.remove.entity", "&f/npcbook interaction remove entity [right/left] $ &9Remove a book from an entity.");
